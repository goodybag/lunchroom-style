# Goodybag Lunchroom Theme

> This fork hosts the Goodybag Lunchroom theme for Semantic UI
...
To customize, make changes within the `/src/site/` directory.

For site wide global changes modify

* __/src/site/globals/site.overrides__ for overriding styles
* __/src/site/globals/site.variables__ for defining variables

Per component customizations can be made in `/src/site/elements/*`
